...
namespace Gestion_Bibliotheque.Formulaire
{
    public partial class ViewBooks : Form
    {
        ...
        private void dataGridView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                bid = int.Parse(dataGridView.Rows[e.RowIndex].Cells[0].Value.ToString());
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            if(MessageBox.Show("Data will be updated. Confirm?", "Success", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
            {
                ...
                cmd.CommandText = "update NewBook set bName = '" + bname + "', bAuthor = '" + bauthor + "', bPubl = '" + publication + "', bDate = '" + pdate + "', bPrice =" + price + ", bQuan=" + quan + " where bid=" + rowid + " ";
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
                da.Fill(ds);
